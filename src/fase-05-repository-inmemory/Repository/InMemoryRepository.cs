...
/// <summary>
/// Implementação InMemory usando Dictionary<TId, T>.
/// Política de id: **Id vem de fora** (o domínio fornece o Id).
/// </summary>
    ...
    where TId : notnull
{
    ...
    {
        // Retorna cópia como IReadOnlyList para evitar exposição da coleção interna
