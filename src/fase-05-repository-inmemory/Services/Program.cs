...
using Fase05.RepositoryInMemory.Services;

Console.WriteLine("Fase 5 — Repository InMemory (CurrencyRate domain)");

// fábrica simples do repositório (ID vem de fora, conforme opção A)
IRepository<CurrencyRate, int> repo = new InMemoryRepository<CurrencyRate, int>(r => r.Id);
