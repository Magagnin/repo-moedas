...
public sealed class InMemoryRepository<T, TId> : IReadRepository<T,TId>, IWriteRepository<T,TId>
    where TId : notnull
{
    ...
    public T? GetById(TId id) => _store.TryGetValue(id, out var v) ? v : default;
